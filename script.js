...
const config = {
    serverInfo: {
        ...
        serverName: "Royal-Network", /*Server name*/
        serverIp: "Royal.mc-crafters.com", /*Server IP (if you want to add online user counter, you must have true the enable-status and enable-query of server.properties)*/
        discordServerID: "1243235940797907034" /*Your server ID (if you want to add online user counter, you must have enabled Discord server widget)*/
    },
    ...
    */
    ...
    adminTeamPage: {
        leaders: [
            {
                inGameName: "Epic_Jishnu",
                rank: "Owner",
                skinUrlOrPathToFile: "",
                rankColor: "rgb(3, 255, 255)"
            },
            {
                inGameName: "ARNO_200K",
                rank: "Owner",
                skinUrlOrPathToFile: "",
    ...
    */
    contactPage: {
        email: "support@umbraixhosting.site"
    }
}
